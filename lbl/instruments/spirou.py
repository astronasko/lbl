...
class Spirou(Instrument):
    ...
    def param_override(self):
        ...
        self.params.set('TELLUCLEAN_MASK_DOMAIN_LOWER', value=950,
                        source=func_name)
        # Define the upper wave limit for the absorber spectrum masks in nm
        self.params.set('TELLUCLEAN_MASK_DOMAIN_UPPER', value=2500,
                        source=func_name)
        ...
        self.params.set('TELLUCLEAN_WAVE_LOWER', value=950, source=func_name)
        # Define the wave griv upper wavelength limit
        self.params.set('TELLUCLEAN_WAVE_UPPER', value=2500, source=func_name)
